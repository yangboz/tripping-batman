package
{
	...
	[SWF(width="960",height="640",frameRate="60",backgroundColor="#4a4137",wmode="direct")]
	public class StarlingFeatherUITesting extends Sprite
	{
		public function StarlingFeatherUITesting()
		{
			if(this.stage)
			{
